...
Contains: Character, Hero and Enemy.
"""
__version__ = "0.1.0"
...
class Heroi(Personagem): # Herança
    ...
    def ataque_especcial(self, alvo):
...
class Inimigo(Personagem): # Herança
    ...
    def iniciar_batalha(self):
        ...
        while self.heroi.get_vida() > 0 and self.inimigo.get_vida() > 0:
            ...
            if escolha == "1":
                ...
                self.heroi.ataque_especcial(self.inimigo)
            else:
